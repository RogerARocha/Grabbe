...
/// Each external client (TMDB, AniList, Open Library) maps its proprietary API response
...
public class GrabbeMediaDTO
{
    ...
    /// <summary>The name of the source API. Valid values: "TMDB", "ANILIST", "OPENLIBRARY", "IGDB".</summary>
